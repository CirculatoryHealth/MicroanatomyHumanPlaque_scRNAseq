celphonedb code.R                        ligand receptor interacion code using cellphonedb (python package)
...
singleR_analyses.R                       perform functional annotation of clusters with the 'singleR' package
...
Single_cell_vs_Bulk.R	                   Compare bulk RNA read to single cell RNA reads and visualisation
GWAS_to_sinlge_cells.R	                 GWAS to single cell analysis and visualisation
